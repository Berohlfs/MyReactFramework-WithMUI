...
export const number_required = z.number().min(1, messages.required)
export const number_optional = z.number()
...
export const email = z.string().min(1, messages.required).email(messages.invalid).max(40, messages.large)
...
export const conta_corrente = z.string().min(1, messages.required).max(10, messages.large)
...
// 'Outros'
export const date = z
    .instanceof(dayjs as unknown as typeof Dayjs, { message: 'Inválido' })
